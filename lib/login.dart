 ...
 //////////////////////////////REGISTER
  ...
  _login(var email,var password) async{
    await http.post('https://newshunt.io/mobile/newsHunt_login.php',body: {'username':email,'password':password})
        .then((response){
        if("${response.body}".contains("notactivated")){Fluttertoast.showToast(
            msg: "Your Account Is Not Activated Yet, Check Your Email !",
        ...
        else if("${response.body}".contains("Not Found")){Fluttertoast.showToast(
            msg: "Not Found!",
            toastLength: Toast.LENGTH_LONG,
            gravity: ToastGravity.CENTER,
            timeInSecForIos: 1,
